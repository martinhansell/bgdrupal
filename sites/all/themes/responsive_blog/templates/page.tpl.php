...
<div id="wrapper">
  <header id="header" class="clearfix">
    ...
    <?php if (theme_get_setting('socialicon_display', 'responsive_blog')): ?>
        <?php 
        $twitter_url = theme_get_setting('twitter_url', 'responsive_blog'); 
        $facebook_url = theme_get_setting('facebook_url', 'responsive_blog'); 
        $google_plus_url = theme_get_setting('google_plus_url', 'responsive_blog'); 
        $pinterest_url = theme_get_setting('pinterest_url', 'responsive_blog');
        ?>
